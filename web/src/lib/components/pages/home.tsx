      ...
      <div id="home-layout">
        <div className="left-column">
			<p>
				...
				<br />Донирајте го сопствениот глас за да ни помогнете да изградиме гласовна база на податоци. Што ќе може да се искористи за да се направат иновативни мобилни и веб апликации за вашите уреди на мајчин јазик.			</p>
		</div>
