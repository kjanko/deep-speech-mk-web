      ...
      <div id="home-layout">
        <div className="left-column">
			<p>
				...
				<br />Треба само да ја прочитате реченицата која ви се прикажува на дисплејот или пак, да ја проверите работата на останатите волонтери кои веќе донирале. Толку е едноставно! 		</div>
